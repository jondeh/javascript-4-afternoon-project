...
// //   // */
  ...
  */
  ...
  User.prototype.removeSavedPost = function(id) {
    let reMove = this.savedPosts.findIndex(function(e){
      return e === id
    })
    this.savedPosts.splice(reMove, 1)
  }
  ...
  User.prototype.changePostRating = function(id, newRat) {
      let changePost = this.savedPosts.find(function(e){
        return e.id === id
      })
      changePost.rating = newRat
      return changePost
  }
